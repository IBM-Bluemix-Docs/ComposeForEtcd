...
Die Wiederherstellung einer älteren Version eines {{site.data.keyword.composeForEtcd}}-Service auf einem neuen Service unter Ausführung von etcd 3.2.13 sieht wie folgt aus: 
```

...
# A propos de {{site.data.keyword.composeForEtcd}}
...
## Création d'une instance de service {{site.data.keyword.composeForEtcd}}
...
## Gestion de {{site.data.keyword.composeForEtcd}}
...
## Connexion d'une application {{site.data.keyword.cloud_notm}} à {{site.data.keyword.composeForEtcd}}
...
## Connexion à {{site.data.keyword.composeForEtcd}} depuis l'extérieur d'{{site.data.keyword.cloud_notm}}

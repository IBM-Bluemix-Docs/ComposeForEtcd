...
![Deployment Details](./images/etcd-deployment-details.png "Una vista del pannello dei dettagli della distribuzione")
...
Puoi gestire il tuo servizio {{site.data.keyword.composeForEtcd}} tramite l'API {{site.data.keyword.cloud_notm}} Compose.

...
Este tutorial usa o app de amostra [compose-etcd-helloworld-nodejs](https://github.com/IBM-Cloud/compose-etcd-helloworld-nodejs) para demonstrar como usar Node.js para se conectar a um serviço {{site.data.keyword.composeForEtcd_full}}. O aplicativo cria, lê e grava em um banco de dados utilizando os dados fornecidos por meio da interface da web do app.
{: shortdesc}
...
## Etapa 8: Verificar se o app está conectado ao serviço {{site.data.keyword.composeForEtcd}}
...
Em vez de enviar o app por push para o {{site.data.keyword.cloud_notm}}, é possível executá-lo localmente para testar a conexão com a instância de serviço do {{site.data.keyword.composeForEtcd}}. Para se conectar ao serviço será necessário criar um conjunto de credenciais de serviço.

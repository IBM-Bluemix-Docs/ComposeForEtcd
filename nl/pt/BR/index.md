...
## Criando uma instância de serviço do Compose for Etcd

[Crie uma instância do {{site.data.keyword.composeForEtcd_full}}](https://console.ng.bluemix.net/catalog/services/compose-for-etcd/).
...
## Gerenciando o Compose for Etcd
...
## Conectando-se ao Compose for Etcd
...
## Conectando um aplicativo {{site.data.keyword.cloud_notm}} ao Compose for Etcd
...
## Conectando-se ao Compose for Etcd de fora do {{site.data.keyword.cloud_notm}}

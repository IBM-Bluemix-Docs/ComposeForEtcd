...
## Creación de una instancia del servicio Compose for Etcd

[Cree una instancia de {{site.data.keyword.composeForEtcd_full}}](https://console.ng.bluemix.net/catalog/services/compose-for-etcd/).
...
## Conexión de una aplicación {{site.data.keyword.cloud_notm}} a Compose for Etcd
...
## Conexión a Compose for Etcd desde fuera de {{site.data.keyword.cloud_notm}}

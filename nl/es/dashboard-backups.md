...
Por ejemplo, la restauración de una versión anterior de un servicio {{site.data.keyword.composeForEtcd}} a un servicio nuevo que ejecute etcd 3.2.13 tendrá este aspecto:
```
